	...
	if (!destroyed && (App->player->position.y - position.y < 165 || appeared))
	{
		...
		else
		{
			...
			if (next_shoot - last_shoot > 450)
			{
				...
				{
					App->particles->AddParticle(App->particles->Big_Tur_Laser, position.x + 15, position.y + 45, { -1, +2 }, { 0, 0, 12, 12 }, COLLIDER_ENEMY_SHOT);
			...
			if (next_shoot - last_shoot > 450)
			{
				...
				{
					App->particles->AddParticle(App->particles->Big_Tur_Laser, position.x + 15, position.y + 45, { -2, +2 }, { 0, 0, 12, 12 }, COLLIDER_ENEMY_SHOT);
					App->particles->AddParticle(App->particles->Big_Tur_Exp, position.x + 5, position.y + 35, { 0, 0 }, nullrect, COLLIDER_NONE);
			...
			if (next_shoot - last_shoot > 450)
			{
				...
				{
					App->particles->AddParticle(App->particles->Big_Tur_Laser, position.x + 15, position.y + 45, { -2, +1 }, { 0, 0, 12, 12 }, COLLIDER_ENEMY_SHOT);
					App->particles->AddParticle(App->particles->Big_Tur_Exp, position.x + 5, position.y + 35, { 0, 0 }, nullrect, COLLIDER_NONE);
