...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_TRUCK][COLLIDER_EXPLOSION] = true;
	matrix[COLLIDER_TRUCK][COLLIDER_ENEMY_SHOT] = true;
	...
	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_TRUCK] = true;
	...
	matrix[COLLIDER_GOD][COLLIDER_MAZURKA] = true;
	matrix[COLLIDER_GOD][COLLIDER_RED_SOLDIER] = true;
	...
	matrix[COLLIDER_EXPLOSION][COLLIDER_TRUCK] = true;
	matrix[COLLIDER_EXPLOSION][COLLIDER_RED_SOLDIER] = true;
	matrix[COLLIDER_EXPLOSION][COLLIDER_MAZURKA] = true;
	matrix[COLLIDER_EXPLOSION][COLLIDER_DOOR] = true;
