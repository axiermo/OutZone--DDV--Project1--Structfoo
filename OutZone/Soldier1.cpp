...
Soldier1::Soldier1(int x, int y, int subtype) :Enemy(x, y, subtype)
{
	...
	case 22:
		...
		path.PushBack({ 1.5f, 0.0f }, 100, &right);
		path.PushBack({ 0.0f, 0.0f }, 5000, &down);
		break;

	case 23:
		path.PushBack({ 0.0f, 1.3f }, 130, &down);
		path.PushBack({ 0.0f, 0.0f }, 40, &up);
		path.PushBack({ 0.0f, -1.0f }, 40, &up);
		path.PushBack({ 1.5, 0.0f }, 80, &right);
		path.PushBack({ 0.0f, 0.0f }, 5000, &down);
		break;

	case 24:
		path.PushBack({ 0.0f, 1.3f }, 130, &down);
		path.PushBack({ 0.0f, 0.0f }, 70, &up);
		path.PushBack({ 0.0f, -1.0f }, 40, &up);
		path.PushBack({ 1.5f, 0.0f }, 60, &right);
		path.PushBack({ 0.0f, 0.0f }, 5000, &down);
		break;
	...
	case 25:
		...
		path.PushBack({ 0.0f, -1.0f }, 40, &up);
		path.PushBack({ 1.5f, 0.0f }, 40, &right);
		path.PushBack({ 0.0f, 0.0f }, 5000, &down);
		break;
